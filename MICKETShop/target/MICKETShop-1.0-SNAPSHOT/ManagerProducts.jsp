    ...
    <body>
                        ...
                        <c:forEach items="${listP}" var="o" varStatus="loop">
                            <tbody>
                                <tr class="mytable">
                                    ...
                                    <td>
                                        <div class="icon-btn">
                                            <a href="detail?pid=${o.id}" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                                            <a href="managerP?action=edit&pid=${o.id}" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                            <a href="managerP?action=delete&pid=${o.id}" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="modal-content">
                        <form action="managerP" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Image</label>
                                    <input name="image" type="text" class="form-control" id="image-input" oninput="updateImage()" required>
                                </div>
                                <div class="form-group">
                                    <label>Price</label>
        ...
        <script>
            function updateImage() {
                var input = document.getElementById("image-input").value;
