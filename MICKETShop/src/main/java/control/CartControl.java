...
public class CartControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!StringUtils.isNumeric(quantityStr)) {
            request.setAttribute("mess2", "Please input a valid quantity.");
            ProductsDTO p = dao.getProductByID(productId);
            List<CategoryDTO> listC = dao.getAllCategory();
            List<SizeDTO> listS = dao.getProductBySize(productId);
            int totalByPid = dao.getTotalSizeByPid(productId);
            ...
            dao.addCart(productId, (sizeId != null) ? sizeId : "", userId, quantity);
...
// <editor-fold defaultstate="collapsed" desc="HttpServlet methods. Click on the + sign on the left to edit the code.">
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CartControl.class
